 ...
 */
final class Version20251009113748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cars ADD status VARCHAR(20) DEFAULT NULL, CHANGE images images JSON DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cars DROP status, CHANGE images images VARCHAR(255) NOT NULL');
    }
}
